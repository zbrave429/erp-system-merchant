 ...
 */
@Data
public class QueryShopContext extends AbstractContext{
    ...
    public QueryShopContext() {}

    public QueryShopContext(ShopQueryRequest request) {
        this.request = request;
    }

    public static QueryShopContext init(ShopQueryRequest request){
        return new QueryShopContext(request);
    }
